...
axs[0,0].plot([i for i in range(40)], E_1, linewidth=2, marker = '.')
axs[0, 0].set_title('\u0394 = 1 minuto',fontsize=10)
axs[0,1].plot([i for i in range(0,40,2)], E_2, linewidth=2, marker = '.')
axs[0, 1].set_title('\u0394 = 2 minutos',fontsize=10)
axs[1,0].plot([i for i in range(0,40,5)], E_5, linewidth=2, marker = '.')
axs[1, 0].set_title('\u0394 = 5 minutos',fontsize=10)
axs[1,1].plot([i for i in range(0,40,10)], E_10, linewidth=2, marker = '.')
